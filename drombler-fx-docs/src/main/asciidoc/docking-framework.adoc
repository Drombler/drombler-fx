...
http://www.drombler.org/DromblerACP/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#inject-D-[Dockables.inject] 
method and then the 
http://www.drombler.org/DromblerACP/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#open-D-[Dockables.open] 
method.
...
[source,xml]
----
include::{resourcesdir}/docking/sample/MyViewPane.fxml[lines=1..13]
----

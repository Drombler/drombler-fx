...
[source,java]
----
include::{sourcedir}/tutorial/action/Test2ToggleAction.java[lines=17..51]
----
...
[source,java]
----
include::{dromblersourcedir}/org/drombler/acp/core/standard/action/impl/SaveAction.java[lines=29..34]
----
...
[source,java]
----
include::{dromblersourcedir}/org/drombler/acp/core/standard/action/impl/SaveAllAction.java[lines=33..38]
----

The "Save" action looks for an instance of the interface 
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/action/command/Savable.html[org.drombler.commons.action.command.Savable]
in the _active context_.
...
_Drombler FX_ checks if an Action implements 
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/context/ActiveContextSensitive.html[org.drombler.commons.context.ActiveContextSensitive]
or 
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/context/ApplicationContextSensitive.html[org.drombler.commons.context.ApplicationContextSensitive]
and injects the active/ application-wide context.

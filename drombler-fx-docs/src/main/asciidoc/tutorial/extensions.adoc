...
http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/ExtensionPoint.html[org.drombler.acp.core.application.ExtensionPoint]
...
When _Drombler FX_ reads the _application.xml_ and it will register each unmarshalled root element as an OSGi service.
...
It's a best practice to provide the annotation processor in the same Maven artifact as the annotation, as this will pick up the annotation processor automatically when using the annotation.

You can extend the 
http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/processing/AbstractApplicationAnnotationProcessor.html[AbstractApplicationAnnotationProcessor]
 ...
 * an instance of the JAXB root element: http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/processing/AbstractApplicationAnnotationProcessor.html#addExtensionConfiguration-java.lang.Object-[addExtensionConfiguration(java.lang.Object)]
 * the model elements with the annotations: http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/processing/AbstractApplicationAnnotationProcessor.html#addOriginatingElements-javax.lang.model.element.Element...-[addOriginatingElements(javax.lang.model.element.Element...)]
 * either the JAXB root element type: 
http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/processing/AbstractApplicationAnnotationProcessor.html#addJAXBRootClass-java.lang.Class-[addJAXBRootClass(java.lang.Class)]
 or the package of the JAXB root element type:
 http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/application/processing/AbstractApplicationAnnotationProcessor.html#addJAXBPackage-java.lang.String-[addJAXBPackage(java.lang.String)]

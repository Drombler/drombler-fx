 ...
 * Tested Java version: 1.8.0_101; Java HotSpot(TM) 64-Bit Server VM 25.101-b13
 * Tested Maven version: 3.0.5
 * Tested OS: Kubuntu 14.04.2 LTS; Linux version 3.13.0-95-generic running on amd64; UTF-8; de_CH (nb)
...
image::getting-started/drombler-sample-application.png[caption="Image 1: ", title="Drombler Sample Application - with 2 Sample Editors: 'Sample 1' and 'Sample 2' and 1 Foo Editor: 'Untitled 3'", alt="Drombler Sample Application - with 2 Sample Editors: 'Sample 1' and 'Sample 2' and 1 Foo Editor: 'Untitled 3'", link="{imagesdir}/getting-started/drombler-sample-application.png"]

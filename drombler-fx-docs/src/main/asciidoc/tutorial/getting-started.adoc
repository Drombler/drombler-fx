 ...
 * Tested Java version: 1.8.0_151; Java HotSpot(TM) 64-Bit Server VM 25.151-b12
 * Tested Maven version: 3.3.9
 * Tested OS: Kubuntu 16.04.1 LTS; Linux version 4.4.0-109-generic running on amd64; UTF-8; de_CH (nb)

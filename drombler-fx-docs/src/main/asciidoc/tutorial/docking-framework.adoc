...
_Docking Areas_ can be registered using the https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/DockingArea.html[@DockingArea] and 
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/LayoutConstraints.html[@LayoutConstraints] annotations on a package (usually in 
_package-info.java_):
...
The https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/DockingArea.html[@DockingArea] properties:
...
The https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/LayoutConstraints.html[@LayoutConstraints] properties:
...
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/docking/DockingAreaKind.html#VIEW[VIEW] Docking Areas and thus are intended for 
view Dockables.
The editor area has been configured to be always visible, even if it's empty. It has been configured as 
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/docking/DockingAreaKind.html#EDITOR[EDITOR] Docking Area and is thus the default 
...
A _Dockable Pane_ can be registered as a _view_ using the https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/ViewDocking.html[@ViewDocking] and 
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/WindowMenuEntry.html[@WindowMenuEntry] annotations:
...
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/ViewDocking.html[@ViewDocking] has the following properties:
...
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/WindowMenuEntry.html[@WindowMenuEntry] has the following properties:
...
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#openEditorForContent-org.softsmithy.lib.util.UniqueKeyProvider-[Dockables.openEditorForContent].


A _Dockable Pane_ can be registered as an _editor_ using the https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/EditorDocking.html[@EditorDocking] annotation:
...
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/data/DataCapabilityProvider.html[DataCapabilityProvider] 
for the 
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/data/Openable.html[Openable] 
_Data Capability_. It tries to open an _Editor_ for a _Data Handler_ by calling
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#openEditorForContent-java.lang.Object-[Dockables.openEditorForContent].

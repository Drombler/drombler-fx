...
This dependency will provide an 
...
So in addition to this dependency you need an <<application-layout.adoc#applicationLayout,Application Layout>>, which supports the ApplicationContentProvider service interface
such as <<application-layout.adoc#standardDesktopClassicLayout,Standard Desktop Classic Layout>>

...
A _Dockable Pane_ can be registered as a _view_ using the http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/api/docs/org/drombler/acp/core/docking/ViewDocking.html[@ViewDocking] and 
...
To open an editor, create an instance using the constructor and then call first the 
http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#inject-D-[Dockables.inject] 
method and then the 
http://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/docking/spi/Dockables.html#open-D-[Dockables.open] 
method.

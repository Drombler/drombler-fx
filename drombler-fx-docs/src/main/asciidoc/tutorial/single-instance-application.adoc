...
If this feature is enabled and one instance is aleady running, each other application start will pass all its http://docs.oracle.com/javase/8/javafx/api/javafx/application/Application.Parameters.html#getUnnamed--[unnamed parameters] to the first instance and shuts 

...
At the core of the _Data Framework_ is the concept of _Data Handlers_. A https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/data/DataHandler.html[Data Handler]
...
https://www.softsmithy.org/softsmithy-lib/lib/{softsmithy-version}/docs/site/apidocs/org/softsmithy/lib/util/UniqueKeyProvider.html[UniqueKeyProvider].
...
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/BusinessObjectHandler.html[@BusinessObjectHandler] annotation:
...
The https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/BusinessObjectHandler.html[@BusinessObjectHandler] properties:
...
As the code sample shows, the easiest way to implement a _Data Handler_ for a business object is to extend https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/AbstractDataHandler.html[AbstractDataHandler].

== Data Handlers for Documents
To register a _Data Handler_ for a document use the 
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/DocumentHandler.html[@DocumentHandler] annotation:
...
The https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/DocumentHandler.html[@DocumentHandler] properties:
...
As the code sample shows, the easiest way to implement a _Data Handler_ for a file based document is to extend https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/AbstractDocumentHandler.html[AbstractDocumentHandler].

=== File Extension
To associate some file extensions with a MIME type you can register the file extensions using the
https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/FileExtension.html[@FileExtension] annotation:
...
The https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/core/data/FileExtension.html[@FileExtension] properties:
...
https://www.drombler.org/drombler-commons/{drombler-commons-version}/docs/site/apidocs/org/drombler/commons/data/file/FileUtils.html#openFile-java.nio.file.Path-org.drombler.commons.data.file.FileExtensionDescriptorRegistry-org.drombler.commons.data.file.DocumentHandlerDescriptorRegistry-[FileUtils.openFile].


=== File Path Arguments Support
The _Data Framework_ registers an implementation of https://www.drombler.org/drombler-acp/{drombler-acp-version}/docs/site/apidocs/org/drombler/acp/startup/main/AdditionalArgumentsProvider.html[AdditionalArgumentsProvider],

...
:toc:
:sourcedir: ../java
:dromblersourcedir: ../../../target/drombler-sources
...
[source,java]
----
include::{sourcedir}/action/Test1Action.java[lines=17..25]
----
...
[source,java]
----
include::{sourcedir}/action/Test2Action.java[lines=17..26]
----
...
[source,java]
----
include::{sourcedir}/action/Test3Action.java[lines=17..26]
----
...
[source,java]
----
include::{sourcedir}/action/Test1ToggleAction.java[lines=17..25]
----
...
[source,java]
----
include::{sourcedir}/action/Test2ToggleAction.java[lines=17..52]
----
...
[source,java]
----
include::{sourcedir}/action/AnnotatedAction.java[lines=17..20]
----
...
[source,java]
----
include::{sourcedir}/action/AnnotatedMenuEntry.java[lines=17..19]
----
...
[source,java]
----
include::{sourcedir}/action/AnnotatedToolBarEntry.java[lines=17..19]
----
...
[source,java]
----
include::{sourcedir}/action/menu/sample/package-info.java[lines=15..19]
----
...
[source,java]
----
include::{sourcedir}/action/toolbar/sample/package-info.java[lines=15..19]
----
...
[source,java]
----
include::{dromblersourcedir}/org/drombler/fx/core/application/impl/ExitAction.java[lines=27..28]
----
...
[source,java]
----
include::{sourcedir}/action/sample/impl/MyAction1.java[lines=15..33]
----
...
[source,java]
----
include::{sourcedir}/action/sample/impl/MyAction2.java[lines=15..55]
----
...
[source,java]
----
include::{sourcedir}/action/sample/impl/MyAction3.java[lines=15..59]
----
...
[source,java]
----
include::{sourcedir}/action/sample/impl/MyToggleAction.java[lines=15..32]
----
